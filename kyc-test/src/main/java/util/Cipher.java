...
public class Cipher {
    ...
    private void Reset() {
        ...
        byte[] p = Util.byteConvert32Bytes(this.p2.getXCoord().toBigInteger());
        this.sm3keybase.update(p, 0, p.length);
        this.sm3c3.update(p, 0, p.length);
        p = Util.byteConvert32Bytes(this.p2.getYCoord().toBigInteger());
        this.sm3keybase.update(p, 0, p.length);
        this.ct = 1;
        this.NextKey();
    }
    ...
    public void Dofinal(byte[] c3) {
        byte[] p = Util.byteConvert32Bytes(this.p2.getYCoord().toBigInteger());
        this.sm3c3.update(p, 0, p.length);
