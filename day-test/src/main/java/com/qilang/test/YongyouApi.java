...
public class YongyouApi {
    ...
    public static void getRequest(){
        String result =null;
        String url ="https://api.yonyoucloud.com/apis/yonyoucloudresearch/enterprise/baseinfo";//请求接口地址
        String method = "GET";
        ...
        headerParams.put("tenantId", "61bea228-ddce-4ab2-aed4-d8a6d3dcrm01");
        headerParams.put("token", "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiIiLCJ0ZW5hbnRJZCI6IjYxYmVhMjI4LWRkY2UtNGFiMi1hZWQ0LWQ4YTZkM2Rjcm0wMSIsImV4cCI6MzMxMTg2MjI5NzIsImlhdCI6MTU4MjYyMjk3MiwianRpIjoiNjFiZWEyMjgtZGRjZS00YWIyLWFlZDQtZDhhNmQzZGNybTAxIn0.M_S-Dwrl3PHGIz0cy4IN0yaDap6-REo3ODfj0kXawl4");
        try {
